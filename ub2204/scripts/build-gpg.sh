...
rm -fr /usr/lib/x86_64-linux-gnu/gnupg/private
_build_zlib
_build_sqlite
###############################################################################
_tmp_dir="$(mktemp -d)"
...
wget 'https://git.gnupg.org/cgi-bin/gitweb.cgi?p=gnupg.git;a=patch;h=600df5259db0b7be25a2e2b06c0c2d13265eceea;hp=a4bd829aa6755c1acd32d67d8336023e4e705675' -O /tmp/p4.patch
wget 'https://git.gnupg.org/cgi-bin/gitweb.cgi?p=gnupg.git;a=patch;h=344353fbdd80779865170beda44eccb06bcdbd81;hp=600df5259db0b7be25a2e2b06c0c2d13265eceea' -O /tmp/p5.patch
wget 'https://git.gnupg.org/cgi-bin/gitweb.cgi?p=gnupg.git;a=patch;h=a966c2ce90802f2fa953b04e69fdc529d61b6f53;hp=344353fbdd80779865170beda44eccb06bcdbd81' -O /tmp/p6.patch
